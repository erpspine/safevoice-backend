...
class CompanyFeedbackCategoryController extends Controller
{
    /**
     * Display a listing of feedback categories for the authenticated company.
     */
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            if ($user->role !== 'company_admin' || !$user->company_id) {
                return response()->json([
                    'success' => false,
                    'message' => 'Access denied. Only company admins can manage feedback categories.'
                ], 403);
            }
    ...
    /**
     * Store a newly created feedback category for the authenticated company.
     */
    ...
    /**
     * Display the specified feedback category (only if it belongs to the authenticated company).
     */
    ...
    /**
     * Update the specified feedback category (only if it belongs to the authenticated company).
     */
    ...
    /**
     * Remove the specified feedback category (only if it belongs to the authenticated company).
     */
    public function destroy(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => "Feedback category '{$categoryName}' deleted successfully"
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
    ...
    /**
     * Get feedback category statistics for the authenticated company.
     */
