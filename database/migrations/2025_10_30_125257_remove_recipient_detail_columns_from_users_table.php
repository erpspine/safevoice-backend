...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            // Remove recipient detail columns (keep recipient_type)
            if (Schema::hasColumn('users', 'primary_recipient_name')) {
            ...
            if (Schema::hasColumn('users', 'alternative_recipient_name')) {
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            // Re-add the recipient detail columns
